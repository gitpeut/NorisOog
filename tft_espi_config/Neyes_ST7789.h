...
#define TFT_DC     5//	PIN_D1  // Data Command control pin
#define TFT_RST    16// PIN_D0  // Reset pin (could connect to NodeMCU RST, see next line)
//#define TFT_RST  -1  // Set TFT_RST to -1 if the display RESET is connected to NodeMCU RST or 3.3V
//  14  D5 --> SCL (Hardware SPI)
//  13  D7 --> SDA (Hardware SPI)
//  16   D0 --> RES (can be change)
//   5  D1 --> DC (can be change)
